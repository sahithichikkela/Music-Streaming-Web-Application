...
const FilterButtons = ({ filterData, flag }) => {
    ...
    return (
        <div className="border border-gray-300 rounded-md px-4 py-1 relative cursor-pointer hover:border-gray-400">
            <p
                className="text-base tracking-wide text-slate-50 flex items-center gap-2 "
            ...
            >
                ...
                <IoChevronDown
                    className={`text-base text-slate-50 duration-150 transition-all ease-in-out ${
            ...
            {filterData && filterMenu && (
                ...
                >
                    {filterData?.map((data) => (
                        <div
                            key={data.name}
                            className="flex items-center gap-2 px-4 py-1 hover:bg-zinc-600"
